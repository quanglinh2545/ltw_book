			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
                        ...
                        <li>
                            <audio controls loop>
                                <source src = "source/image/Jingle.mp3" type = "audio/mp3">
                            </audio>
                        </li>
					</ul>
				</div>
								...
								<div class="cart-item">
									...
									<div class="media">
										...
										<div class="media-body">
											...
											<span class="cart-item-amount">{{$product['qty']}}*<span>@if($product['item']['promotion_price'] == 0){{number_format($product['item']['unit_price'])}} @else {{number_format($product['item']['promotion_price'])}} @endifđ</span></span>
										</div>
									</div>
								</div>
								@endforeach
